...
for stride, h_type, n_slice, metric in grid(strides, h_types, n_slices, knn_metrics):
    print("Evaluate for stride: ", stride, " h_type: ", h_type, " n_slice: ", n_slice, " with knn metric: ", metric)

    # Initialization
    rgb_histogram = EdgeHistogram(stride=stride, n_slice=n_slice, h_type=h_type)
